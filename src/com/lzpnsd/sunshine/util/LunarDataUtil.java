...
//	static SimpleDateFormat chineseDateFormat = new SimpleDateFormat("MM月dd日");
	final static long[] lunarInfo = new long[] { 
		...
		0x055c0, 0x0ab60, 0x096d5, 0x092e0, 0x0c960, 0x0d954, 
	 ...
	 */
	public LunarDataUtil(Calendar cal) {
...
//		return year + "年" + (leap ? "闰" : "") + chineseNumber[month - 1] + "月" + getChinaDayString(day);
	...
	/*public static void main(String[] args) throws ParseException {
		...
		LunarDataUtil data = new LunarDataUtil(today);
		System.out.println("北京时间：" + chineseDateFormat.format(today.getTime()) + "　农历" + data);
		//北京时间：2011年12月19日　农历2011年十一月廿五
	}*/
}
